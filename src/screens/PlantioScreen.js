...
const styles = StyleSheet.create({
    ...
    card: { backgroundColor: '#FFF', borderRadius: 18, overflow: 'hidden', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.07, shadowRadius: 8, marginBottom: 22 },
    cardHeader: { padding: 22, backgroundColor: '#176E46' },
    headerTitle: { fontSize: 16, fontWeight: '900', color: '#FFF', letterSpacing: 0.5 },
    headerSub: { fontSize: 12, color: 'rgba(255,255,255,0.85)', marginTop: 3, fontWeight: '600' },
    form: { padding: 20 },
    field: { marginBottom: 18 },
    row: { flexDirection: 'row' },
    label: { fontSize: 11, fontWeight: '700', color: '#6E6E6E', marginBottom: 6, letterSpacing: 0.5, textTransform: 'uppercase' },
    input: { backgroundColor: '#FFF', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 13, fontSize: 15, borderWidth: 1, borderColor: '#D9D9D9', color: '#1E1E1E' },
    selectBtn: { backgroundColor: '#FFF', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 13, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderColor: '#D9D9D9' },
    ...
    histTitle: { fontSize: 12, fontWeight: '800', color: '#6E6E6E', marginBottom: 14, letterSpacing: 0.5 },
    histCard: { backgroundColor: '#FFF', padding: 15, borderRadius: 16, flexDirection: 'row', alignItems: 'center', marginBottom: 10, elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 6 },
    histIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#1F8A5B', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
    histCultura: { fontSize: 15, fontWeight: '800', color: '#1E1E1E' },
    histLocal: { fontSize: 12, color: '#6E6E6E', fontWeight: '600' },
    histDate: { fontSize: 12, fontWeight: '800', color: '#6E6E6E' },

    overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
    modalBg: { backgroundColor: '#FFF', borderTopLeftRadius: 22, borderTopRightRadius: 22, height: '70%', padding: 20 },
    ...
    itemText: { fontSize: 15, fontWeight: '700', color: '#1E1E1E' },
    itemSub: { fontSize: 11, color: '#6E6E6E' },
    empty: { textAlign: 'center', marginTop: 50, color: '#6E6E6E', paddingHorizontal: 40 }
});
