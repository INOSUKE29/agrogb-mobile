...
const styles = StyleSheet.create({
    ...
    label: { fontSize: 10, fontWeight: 'bold', color: '#9CA3AF', marginBottom: 8, marginTop: 10 },
    pillContainer: { flexDirection: 'row', marginBottom: 20, gap: 10 },
    pill: { flex: 1, padding: 12, borderRadius: 8, backgroundColor: '#111827', borderWidth: 1, borderColor: '#334155', alignItems: 'center' },
    pillActive: { backgroundColor: '#052e16', borderColor: '#22C55E' },
    pillText: { fontWeight: 'bold', color: '#9CA3AF', fontSize: 12 },
    ...
    attachBtn: { flex: 1, backgroundColor: '#111827', padding: 20, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#334155', borderStyle: 'dashed' },
    attachText: { fontSize: 12, fontWeight: 'bold', color: '#22C55E', marginTop: 5 },
